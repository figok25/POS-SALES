<x-admin-layout>
    <div class="p-6 max-w-3xl">
        <h1 class="text-xl font-semibold mb-4">Buat Draft Permintaan Barang</h1>
        ...
        <form method="POST" action="{{ route('admin.distribution.stock-requests.store') }}" class="bg-white p-4 rounded shadow">
            @csrf
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    <label class="block text-sm font-medium mb-1">Assign Sales</label>
            ...
            <p class="text-xs text-gray-500 mb-4">Dokumen akan tersimpan sebagai Draft. Belum ada perubahan stock pada tahap ini (Blueprint #8).</p>

            <div class="flex justify-end gap-2">
                <a href="{{ route('admin.distribution.stock-requests.index') }}" class="px-3 py-2 text-sm rounded border">Batal</a>
    ...
    <script>
        ...
        // Minimal satu baris item saat form dibuka.
        addItemRow();
    </script>
</x-admin-layout>
