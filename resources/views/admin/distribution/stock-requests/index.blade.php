<x-admin-layout>
    <div class="p-6">
        <div class="flex items-center justify-between mb-4">
            <h1 class="text-xl font-semibold">Permintaan Barang</h1>
            @can('distribution.manage')
                <a href="{{ route('admin.distribution.stock-requests.create') }}" class="bg-blue-600 text-white px-3 py-2 rounded text-sm hover:bg-blue-700">+ Buat Draft</a>
            @endcan
        </div>
                        ...
                        <tr class="border-b">
                            ...
                            <td class="px-3 py-2">
                                ...
                                @elseif ($item->status === 'submitted')
                                    <span class="text-blue-700 bg-blue-100 px-2 py-0.5 rounded text-xs">Submitted</span>
                                @else
                            ...
                            <td class="px-3 py-2 text-right">
                                <a href="{{ route('admin.distribution.stock-requests.show', $item) }}" class="text-blue-700 hover:underline">Detail</a>
                            </td>
                        </tr>
                    @empty
