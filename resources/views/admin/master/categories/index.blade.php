<x-admin-layout>
    <div class="p-6">
        <div class="page-header">
            ...
            <a href="{{ route('admin.master.categories.create') }}" class="btn btn-primary">+ Tambah Category</a>
        </div>
        ...
        <form method="GET" class="search-bar">
            <input type="text" name="q" value="{{ $search }}" placeholder="Cari Category..." class="form-control">
                    ...
                    @forelse ($items as $item)
                        <tr>
                            ...
                            <td class="text-right space-x-3">
                                <a href="{{ route('admin.master.categories.edit', $item) }}" class="link-muted">Edit</a>
