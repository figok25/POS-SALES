<x-admin-layout>
    <div class="p-6 max-w-xl">
        ...
        <form method="POST" action="{{ route('admin.master.suppliers.update', $item) }}" class="bg-white p-4 rounded shadow">
            @csrf
            @method('PUT')
        ...
        <div class="mb-4">
            ...
            <div class="flex justify-end gap-2">
                <a href="{{ route('admin.master.suppliers.index') }}" class="px-3 py-2 text-sm rounded border">Batal</a>
