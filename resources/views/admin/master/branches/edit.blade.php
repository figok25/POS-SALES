<x-admin-layout>
    <div class="p-6 max-w-xl">
        <h1 class="page-title mb-4">Edit Branch</h1>
        <form method="POST" action="{{ route('admin.master.branches.update', $item) }}" class="panel panel-body">
            @csrf
            @method('PUT')
            ...
            <div class="form-actions">
                <a href="{{ route('admin.master.branches.index') }}" class="btn btn-outline">Batal</a>
