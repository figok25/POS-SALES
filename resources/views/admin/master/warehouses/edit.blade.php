<x-admin-layout>
    <div class="p-6 max-w-xl">
        <h1 class="text-xl font-semibold mb-4">Edit Warehouse</h1>
        <form method="POST" action="{{ route('admin.master.warehouses.update', $item) }}" class="bg-white p-4 rounded shadow">
            @csrf
            @method('PUT')
