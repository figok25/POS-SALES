<x-admin-layout>
    <div class="p-6 max-w-xl">
        <h1 class="text-xl font-semibold mb-4">Edit Sales</h1>
        <form method="POST" action="{{ route('admin.master.sales.update', $item) }}" class="bg-white p-4 rounded shadow">
            @csrf
            @method('PUT')
        ...
        <div class="border-t pt-4 mt-2 mb-4">
            ...
            <div class="flex justify-end gap-2">
                <a href="{{ route('admin.master.sales.index') }}" class="px-3 py-2 text-sm rounded border">Batal</a>
